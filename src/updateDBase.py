...
# 'reference': , 'cluster90_grp_name: ', 'operon_grp_name': , 'function_grp_names': , 'mechanism_names': , 'taxonomy': code|species,}
...
def read_csv_DBase(csvFilename):
    ...
    for n, sdic in enumerate(dicList):
        ddic = {'source':'','entry_name':'','alternative_names':'','nomenclature_trouble':'','mol_type':'cds',
                ...
                'comment':'','taxonomy':'','reference':'','curated_by':''}
...
def insert_record(cnrDict, source_dict, skey):
    ...
    #=> collecter et affecter cluster90_grp_name, function_grp_names, mechanism_names
    cluster90_grp_name = []
    function_grp_names = []
    mechanism_names = []
...
# 'reference': , 'cluster90_grp_name: ', 'function_grp_names': , 'mechanism_names': , 'taxonomy': code|species,}
